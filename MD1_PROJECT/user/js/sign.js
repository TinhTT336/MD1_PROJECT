...
document.getElementById("form-signup").addEventListener("submit", function (e) {
    ...
    document.getElementById("signup_img").addEventListener("change", function (e) {
        document.getElementById("avatar").src = `../image/${e.target.files[0].name}`
