        ...
        return (string +
            `  <tr>
                    ...
                    <td><a onclick="handleUpdate(this,${item.idProduct})" href="#"><i
                                class="bi bi-pencil-square"></i>Cập nhật</a></td>
                </tr>`)
    }, "")
...
const handleCheckOut = () => {
    ...
    let order_details = [];
    let total_price = 0;
    // let btnCheckout = document.getElementById("btn-handlecheckout");
    console.log(userSignin.cart.length);
    if (userSignin.cart.length > 0) {
...
// btnCheckout.userSignin.cart.length == 0 ? "no_click" : ""
