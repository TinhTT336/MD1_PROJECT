...
const showListProducts = (list = products) => {
    ...
    for (let i = 0; i < list.length; i++) {
        ...
        strHTML += `  <tr>
                    ...
                    <td> <button type="button" class="btn btn_edit" onclick="editProduct(${element.product_id})"> <i class="bi bi-pencil-square" ></i> Sửa</button></td>
                    <td> <button type="button" class="btn btn_delete" onclick="deleteProduct(${element.product_id})"><i class="bi bi-trash-fill" ></i> Xoá</button></td>
                    </tr> `
    }
